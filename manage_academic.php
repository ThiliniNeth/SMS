                            ...
                            <div class="col-9 bg-secondary bg-opacity-10">
                                <div class="row justify-content-center">
                                    <div class="col-12 shadow-lg">
                                        <h3>Admin | Manage Academic Officer
                                        </h3>
                                    </div>
                                    ...
                                    <form action="manage_academic.php" method="post">
                                        <div class="row">
                                        <div class="col-3  ">
                                            <img src="pics/54.png" class="w-100 mt-3 ">
                                            
                                        </div>  

                                            <div class="col-4 mx-4">
                                                <div class="row">
                                                    <label class="mt-4">Academic Officer's Email</label>
                                ...
                                <button class="btn btn-outline-dark col-2" name="submit">Add</button>
                                             <br>
                                            <a href="delete_academic.php" class="btn btn-outline-dark col-2 " style="margin-left: 10px;" name="delete">Delete</a>
                                            <a href="update_academic.php" class="btn btn-outline-dark col-2 " style="margin-left: 10px;"  name="update">Update</a>
                                            <a href="search_academic.php" class="btn btn-outline-dark col-2 " style="margin-left: 10px;"  name="search">Search</a>
                                            </div>
                                </div>
...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        else
        {
            ...
            $query = " INSERT INTO `academic_officer` (`email`,`username`,`password`,`fname`,`lname`,`contact`,`gender`,`dob`) VALUES 
           (?, ?, ?, ?, ?, ?, ?, ?)";
