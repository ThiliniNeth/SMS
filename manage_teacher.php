                            ...
                            <div class="col-9 bg-secondary bg-opacity-10">
                                <div class="row justify-content-center">
                                    ...
                                    <form action="manage_teacher.php" method="post">
                                        <div class="row">
                                        <div class="col-3  ">
                                            <img src="pics/teacher.jpg" class="w-100 mt-3 ">
                                ...
                                <button class="btn btn-outline-dark col-2" name="submit">Add</button>
                                             <br>
                                            <a href="delete_teacher.php" class="btn btn-outline-dark col-2 " style="margin-left: 10px;" name="delete">Delete</a>
                                            <a href="update_teacher.php" class="btn btn-outline-dark col-2 " style="margin-left: 10px;"  name="update">Update</a>
                                            <a href="search_teacher.php" class="btn btn-outline-dark col-2 " style="margin-left: 10px;"  name="search">Search</a>
                                            </div>
                                </div>
...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        else
        {
            ...
            $query = " INSERT INTO `teacher` (`email`,`username`,`password`,`fname`,`lname`,`contact`,`gender`,`dob`) VALUES 
           (?, ?, ?, ?, ?, ?, ?, ?)";
