                            ...
                            <div class="col-9 bg-secondary bg-opacity-10">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="card col-11 col-lg-3 p-4 p-lg-3 mt-2  rounded-3  mx-auto" style="width: 25rem;">
                                            <div class="card-body">
                                            ...
                                            <p class="card-text fw-bold" style="color:green;"> Checked all: Yes</p>
                                            <input class="form-control mt-1" type="file" >
                                            <button type="button" class="btn btn-outline-warning mt-4">Send Results to Academic Officer</button>
                                            </div>
                                        </div>
