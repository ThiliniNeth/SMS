                                        ...
                                        <div class="row border border-2 border-dark rounded-1 mt-5">
                                            ...
                                            <div class="d-none d-lg-block col-12 bg-dark text-light bg-opacity-50">
                                                <div class="row">
                                                    ...
                                                    <div class="col-2  mx-auto"><label>Class</label>
                                                    </div>
                                                    <div class="col-2  mx-auto"><label>Marks</label>
                                                    </div>
                                                    <div class="col-3  mx-auto"> <label>Status</label>
                                                    </div>
                                                ...
                                                <div>
                                                    ...
                                                    <div class="col-12 mt-3 mb-3">
                                                        <div class="row">
                                                            ...
                                                            <div
                                                                class="col-12 col-lg-1 text-lg-center mx-lg-auto mt-2 mt-lg-auto mb-lg-auto">
                                                                <small><label class="d-lg-none text-start">Class
                                                                        :</label>
                                                                    A-</small>
                                                            </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <small><label class="d-lg-none text-start">Marks
                                                                        :</label>
                                                                    75 </small>
                                                            </div>
                                                            <div
                                                                class="col-12 col-lg-3  mx-lg-auto mt-2 mt-lg-auto mb-lg-auto fw-bold" style="color:green;">
                                                                <small><label class="d-lg-none text-start " >Status
                                                                        :</label>
                                                                        Pass</small>
                                                            </div>
