                                ...
                                <div class="row justify-content-center">
                                    <div class="mt-3 mb- col-11">
                                        <div class="row">
                                            ...
                                            <div class="mt-2 mb-2 btn-group dropend"> <button type="button"
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item btn btn-outline-dark"
                                                            href="admin_panel_doctor_specialization.html">View All Admins
                                                            </a></li>
                                                    <li><a class="dropdown-item btn btn-outline-dark"
                                            ...
                                            <div class="mt-2 mb-2"> <a class="btn btn-outline-dark col-12"
                                                    href="admin_panel_doctor_session_logs.html">
                            ...
                            <div class="col-9 bg-secondary bg-opacity-10">
                                <div class="row justify-content-center">
                                    <div class="col-12 shadow-lg">
                                        <h3>Admin | Invite Academic Officers
                                        </h3>
                                    </div>
                                    <div class="col-10 mt-5">
                                    <form action="invite_academic.php" method="post">
                                        <div class="row">
...
<?php
    ...
    if (isset($_POST["submit"]))
    {
        ...
        try {
            ...
            $sql = "INSERT INTO `academic_officer` (`email`, `username`, `password`, `fname`, `lname`, `contact`, `gender`, `verification_code`, `email_verified_at`) VALUES ('" . $email . "', '" . $username . "', '" . $encrypted_password . "', '" . $fname . "', '" . $lname . "', '" . $contact . "', '" . $gender . "', '" . $verification_code . "', NULL)";
