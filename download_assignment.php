                                        ...
                                        <div class="row border border-2 border-dark rounded-1 mt-5">
                                            ...
                                            <div class="d-none d-lg-block col-12 bg-dark text-light bg-opacity-50">
                                                <div class="row">
                                                    ...
                                                    <div class="col-2  mx-auto"> <label>Download</label>
                                                    </div>
                                                    <div class="col-2  mx-auto"> <label>Upload</label></div>
                                                ...
                                                <div>
                                                    ...
                                                    <div class="col-12 mt-3 mb-3">
                                                        <div class="row">
                                                            ...
                                                            <div
                                                                class="col-12 col-lg-2  mx-lg-auto mt-2 mt-lg-auto mb-lg-auto">
                                                            ...
                                                            <div
                                                                class="col-12 col-lg-2  mx-lg-auto mt-2 mt-lg-auto mb-lg-auto">
                                                                <small><label class="d-lg-none text-start">Upload
                                                                        :</label>
                                                                        ...
                                                                        <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                                                            ...
                                                                            <div class="modal-dialog">
                                                                                ...
                                                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Assignment Upload</h1>
                                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                                </div>
                                                                                    <div class="modal-body">
                                                                                    
                                                                                    
                                                                                    <label class="mt-4">Student Name</label>
                                                                                    <input type="text "class="form-control mt-1">

                                                                                    <label class="mt-4">Index Num</label>
                                                                                     <input type="text "class="form-control mt-1">
                                                                                    ...
                                                                                    <label class="mt-4">NIC</label>
                                                                                    <input type="text "class="form-control mt-1">

                                                                                    <label class="mt-4">Upload Assignment</label>
