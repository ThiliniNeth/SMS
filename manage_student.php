                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mt-2 mb-2 btn-group dropend"> <button type="button"
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a class="dropdown-item btn btn-outline-dark"
                                                            href="admin_panel_add_doctor.html">Update Admins</a></li>
                            ...
                            <div class="col-9 bg-secondary bg-opacity-10">
                                ...
                                <div class="col-12 mt-5">
                                            ...
                                            <button class="btn btn-outline-dark col-2" name="submit">Add</button>
                                             <br>
                                            <a href="delete_student.php" class="btn btn-outline-dark col-2 " style="margin-left: 10px;" name="delete">Delete</a>
                                            <a href="update_student.php" class="btn btn-outline-dark col-2 " style="margin-left: 10px;"  name="update">Update</a>
                                            <a href="search_student.php" class="btn btn-outline-dark col-2 " style="margin-left: 10px;"  name="search">Search</a>
                                            </div>
                                </div>
