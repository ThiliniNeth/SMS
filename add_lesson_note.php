                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="card col-11 col-lg-3 p-4 p-lg-3 mt-2 bg-light bg-gradient shadow-lg rounded-3  mx-auto" style="width: 18rem;">
                                            <div class="card-body">
                                            <h5 class="card-title">Note 1 </h5><hr>
                                            ...
                                            <p class="card-text fw-bold" style="color:green;"> Release Stats: Yes</p>
                                        ...
                                        <div class="card col-11 col-lg-3 p-4 p-lg-3 mt-2 bg-light bg-gradient shadow-lg rounded-3  mx-auto" style="width: 18rem;">
                                            <div class="card-body">
                                            <h5 class="card-title">Note 2 </h5><hr>
                                           
                                            <p class="card-text">Unit Name: WP 1</p>
                                            <p class="card-text">Unit ID: H7DT 02</p>
                                           
                                            <p class="card-text">Added Date:2023/8/02</p>
                                            <p class="card-text">Number of Students: 956</p>
